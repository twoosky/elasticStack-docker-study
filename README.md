...
3. Node
    ...
    * Split Brain
      ...
      * 이를 방지하기 위해 마스터 후보 노드를 3개로 두고, 클러스터에 마스터 후보 노드가 최소 2개 이상 존재하는 클러스터만 동작하게 구현
      ...
      <img src="https://gblobscdn.gitbook.com/assets%2F-Ln04DaYZaDjdiR_ZsKo%2F-LnUyizASxjZepqPV1G1%2F-LnKxRWUMYG5ATpsysHP%2Fimage.png?alt=media&token=560fe149-3215-44d8-8f3c-c6383146c205" width="200px" height="100px" title="px(픽셀) 크기 설정" alt="RubberDuck"></img><br/>
